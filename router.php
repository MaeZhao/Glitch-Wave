...
if (preg_match('/^\/public\//', $request_uri)) {
  ...
  return False;
} else if (match_routes($request_uri, ['/', '/home', '/music'])) {
  require 'pages/home.php';
} else if (match_routes($request_uri, ['/playlist', '/playlists'])) {
  require 'pages/playlist.php';
} else if (match_routes($request_uri, ['/login', '/sign-in'])) {
  require 'pages/login.php';
} else if (match_routes($request_uri, ['/home/song', '/playlist/song'])) {
  require 'pages/song.php';
} else {
